...
function Tijuana() {
  ...
  function initMap () {
    ...
    let casaPrado = {lat: 32.51286618836283, lng: -117.0391469903813 }
      let map = new google.maps.Map (
        document.getElementById('map'), {zoom:12, center: casaPrado, mapId:"412b8d6956ab707b"}
      );
