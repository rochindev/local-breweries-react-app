...
function Ensenada() {
  ...
  function initMap () {
    ...
    let ensenada = {lat: 31.86573090297282, lng: -116.5943133549657}
      let map = new google.maps.Map (
        document.getElementById('map'), {zoom:12, center: ensenada, mapId:"412b8d6956ab707b"}
      );
